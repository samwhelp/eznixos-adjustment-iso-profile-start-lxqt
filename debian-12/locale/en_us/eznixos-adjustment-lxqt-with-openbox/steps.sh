...
THE_DEFAULT_DISTRO="${THE_DEFAULT_DISTRO:=main-lxqt}"
...
mod_iso_profile_base () {
	...
	local distro_name="eznixos-lxqt"
...
mod_overlay_package_list () {
	...
	util_error_echo
	util_error_echo "cp -rf ${THE_PLAN_PACKAGE_DIR_PATH}/lxqt/. ${THE_PLAN_PROFILE_PACKAGES_DIR_PATH}"
	cp -rf "${THE_PLAN_PACKAGE_DIR_PATH}/lxqt/." "${THE_PLAN_PROFILE_PACKAGES_DIR_PATH}"
